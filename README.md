Filename Normalizer is a tiny command line tool that fixes filenames that use wrong unicode normalization. This issue may happen on fileservers that are used improperly with different operating systems.
